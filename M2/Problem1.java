...
public class Problem1 extends BaseClass {
    ...
    private static void printOdds(int[] arr, int arrayNumber){
        ...
        // - Use modulo operation to check if element is odd (value % 2 != 0)
        // - If the element is odd, print it
        // - Maintain formatting: elements should be printed on the same line separated by commas
        ...
        boolean firstPrinted = false; // to handle comma placement
        for (int i = 0; i < arr.length; i++) {
            if (arr[i] % 2 != 0) { // if the value is odd
                if (firstPrinted) {
                    System.out.print(", ");
                }
    ...
    public static void main(String[] args) {
        final String ucid = "ps55"; // <-- change to your UCID
